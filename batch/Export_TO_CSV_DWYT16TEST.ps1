...
#Invoke-SQLcmd -ServerInstance V-AZD-SQL-11 -Query "exec [HUBSPOT].[dbo].[BUILD_HUBSPOT_TRITON_SS_BOOKINGS]" | Export-Csv -NoTypeInformation $($expLocation + "HUBSPOT_TRITON_SS_BOOKINGS_" + $currdate + ".csv")
#Invoke-SQLcmd -ServerInstance V-AZD-SQL-11 -Query "exec [HUBSPOT].[dbo].[BUILD_HUBSPOT_TRITON_SS_QUOTES]" | Export-Csv -NoTypeInformation $($expLocation + "HUBSPOT_TRITON_SS_QUOTES_" + $currdate + ".csv")
#Invoke-SQLcmd -ServerInstance V-AZD-SQL-11 -Query "exec [HUBSPOT].[dbo].[BUILD_HUBSPOT_TRITON_SS_BROCHURE_REQUESTS]" | Export-Csv -NoTypeInformation $($expLocation + "HUBSPOT_TRITON_SS_BROCHURE_REQUESTS_" + $currdate + ".csv")
#Invoke-SQLcmd -ServerInstance V-AZD-SQL-11 -Query "exec [HUBSPOT].[dbo].[BUILD_HUBSPOT_TRITON_SS_ENEWS]" | Export-Csv -NoTypeInformation $($expLocation + "HUBSPOT_TRITON_SS_ENEWS_" + $currdate + ".csv")

#Invoke-SQLcmd -ServerInstance V-AZD-SQL-11 -Query "exec [HUBSPOT].[dbo].[BUILD_HUBSPOT_TRITON_TM_BOOKINGS]" | Export-Csv -NoTypeInformation $($expLocation + "HUBSPOT_TRITON_TM_BOOKINGS_" + $currdate + ".csv")
#Invoke-SQLcmd -ServerInstance V-AZD-SQL-11 -Query "exec [HUBSPOT].[dbo].[BUILD_HUBSPOT_TRITON_TM_QUOTES]" | Export-Csv -NoTypeInformation $($expLocation + "HUBSPOT_TRITON_TM_QUOTES_" + $currdate + ".csv")
#Invoke-SQLcmd -ServerInstance V-AZD-SQL-11 -Query "exec [HUBSPOT].[dbo].[BUILD_HUBSPOT_TRITON_TM_BROCHURE_REQUESTS]" | Export-Csv -NoTypeInformation $($expLocation + "HUBSPOT_TRITON_TM_BROCHURE_REQUESTS_" + $currdate + ".csv")
#Invoke-SQLcmd -ServerInstance V-AZD-SQL-11 -Query "exec [HUBSPOT].[dbo].[BUILD_HUBSPOT_TRITON_TM_ENEWS]" | Export-Csv -NoTypeInformation $($expLocation + "HUBSPOT_TRITON_TM_ENEWS_" + $currdate + ".csv")
